...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q580, continuing Plan V1's own
  numbering. **140 of 148 resolved.** Q577–Q580 are open *design* questions
  raised by the Search spec (sub-project #11) and block parts of its plan.
...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q580, **140 of 148 resolved**. Q577–Q580 are open Search design questions; the other four left are customer inputs — Q480 (SharePoint site URL), Q547 (drawing filename pattern), Q550 (Cars / OH&S contents) and Q572 (what the Scope tab holds).
...
- `docs/superpowers/specs/2026-09-24-search-design.md` + `docs/superpowers/plans/2026-09-24-search.md` — Global Search (sub-project #11, Plan V1 §13): Meilisearch, trigger-fed outbox + worker, migration `0033` reserved. **Not started**; blocked in part on Q577–Q580.
