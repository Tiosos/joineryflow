...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q567, continuing Plan V1's own
  numbering. **132 of 135 resolved; every answerable question is answered.**
  Q552–Q567 were raised *while building* the Cutlist sub-project, each where a
...
make test         # pytest in api container (59 test files, 613 tests)
...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q567, **132 of 135 resolved**. Every answerable question is answered; the three left are customer inputs — Q480 (SharePoint site URL), Q547 (drawing filename pattern), Q550 (Cars / OH&S contents).
