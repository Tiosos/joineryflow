...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q576, continuing Plan V1's own
  numbering. **140 of 144 resolved; every answerable question is answered.**
...
- `docs/plan-v1/OPEN-QUESTIONS.md` — Q432–Q576, **140 of 144 resolved**. Every answerable question is answered; the four left are customer inputs — Q480 (SharePoint site URL), Q547 (drawing filename pattern), Q550 (Cars / OH&S contents) and Q572 (what the Scope tab holds).
